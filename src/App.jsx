    ...
    <>
      <div className='bg-dark d-flex justify-content-center align-items-center' style={{ height: '100vh', width: '100%' }}>
        <div className='bg-light p-5 rounded-2' style={{ width: '500px' }}>
          ...
          <div className='bg-warning p-3 mt-4 d-flex justify-content-center align-items-center rounded flex-column' style={{ height: '200px' }}>
            <h1>{bmi > 0 ? bmi : ""}</h1>
          ...
          <div className="mb-3 d-flex justify-content-between">
            ...
            <Button
              variant="outlined"
              style={{ width: '190px' }}
              className='p-4 bg-warning text-light'
              onClick={handleReset}
            >
              Reset
            </Button>
